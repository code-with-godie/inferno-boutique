...
const ProductDetails = ({
  ...
  const schema = z.object({
    title: z
      .string()
      .min(2, { message: "product title must be greater than 2 charactor" }),
    price: z.number({ message: "price is required" }),
    category: z
      .string()
      .min(2, { message: "product category must be greater than 2 charactor" }),
    description: z.string().optional(),
    brand: z
      .string()
      .min(2, { message: "product brand must be greater than 2 charactor" }),
    climates: z
    ...
    rating: z
      .number()
      .min(1, "rating must be btn 1-5")
      .max(5, "rating must be btn 1-5")
      .default(4.5),
  ...
  const onSubmit = async (data) => {
    ...
    if (images.length < 2) {
      alert("atleast two images are required");
      return;
    }
    try {
      const done = await updateProduct(updatedProduct);
      if (done) {
        ...
        >
              ...
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.title ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.title ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.title ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.title ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
            ...
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.price ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.price ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.price ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.price ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
                    color: "white", // Input text color
                  },
            ...
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.category ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.category ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.category ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.category ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
                    color: "white", // Input text color
                  },
            ...
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.brand ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.brand ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.brand ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.brand ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
                    color: "white", // Input text color
                  },
            ...
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.stock ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.stock ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.stock ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.stock ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
                    color: "white", // Input text color
                  },
          ...
          <div className=' flex flex-col md:flex-row gap-2 flex-wrap items-center'>
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.rating ? "tomato" : "white", // Border color based on error
                    },
                    "&:hover fieldset": {
                      borderColor: errors.rating ? "tomato" : "white",
                    },
                    "&.Mui-focused fieldset": {
                      borderColor: errors.rating ? "tomato" : "white", // Focused border color based on error
                    },
                  },
                  "& .MuiInputLabel-root": {
                    color: errors.rating ? "tomato" : "white", // Label color based on error
                  },
                  "& .MuiInputBase-input": {
                    color: "white", // Input text color
                  },
            ...
            <div className=' flex flex-col gap-1 flex-1'>
              <TextField
                ...
                name='discount'
                helperText={errors.rating?.discount}
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderColor: errors.rating ? "tomato" : "white", // Border color based on error
          ...
          <div>
            ...
            <Controller
              name='climates'
              control={control}
              defaultValue={climates} // Provide a default value
              render={({ field }) => (
                <>
                  <FormControlLabel
                    control={
            ...
            />
            {errors.climates && (
              <p className=' text-red-500 text-sm'>{errors.climates.message}</p>
            )}
          </div>
          <div className=' flex flex-col gap-1 flex-1'>
          ...
          <div className=' flex flex-col gap-1'>
            <button
              type='submit'
              className=' flex-1  p-2 bg-textSoft border-none cursor-pointer outline-none '
            >
